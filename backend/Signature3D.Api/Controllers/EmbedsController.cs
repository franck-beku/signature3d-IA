...
public class EmbedsController : ControllerBase
{
    ...
    public async Task<IActionResult> GetEmbed(string slug)
    {
        ...
        return Ok(new
        {
            ...
            luxediaPrimaryColor            = project.LuxediaPrimaryColor,
            luxediaWidgetBgColor           = project.LuxediaWidgetBgColor,
            luxediaBotMessageColor         = project.LuxediaBotMessageColor,
            luxediaUserMessageColor        = project.LuxediaUserMessageColor,
            luxediaWidgetPosition          = project.LuxediaWidgetPosition,
            luxediaButtonIcon              = project.LuxediaButtonIcon,
            luxediaLanguage                = project.LuxediaLanguage,
            luxediaTone                    = project.LuxediaTone,
            luxediaPersonalityInstructions = project.LuxediaPersonalityInstructions,
        });
    }
