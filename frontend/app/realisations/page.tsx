...
export default function RealisationsPage() {
  ...
  return (
    <main style={{ backgroundColor: '#FFFFFF', minHeight: '100vh' }}>
        ...
        <section style={{ backgroundColor: '#FFFFFF', padding: '72px 0 56px' }}>
          <div className="container-main" style={{ textAlign: 'center' }}>
            ...
            <p style={{
              ...
              fontSize: '16px', lineHeight: 1.75, color: '#666', fontWeight: 400,
            }}>
        ...
        <section style={{ backgroundColor: '#FAFAF8', padding: '0 0 96px', minHeight: '300px' }}>
          <div className="container-main">
            {loading ? (
              ...
              <div style={{ textAlign: 'center', padding: '80px 0', color: '#999', fontSize: '15px' }}>Aucun secteur disponible pour le moment.</div>
            ) : (
                  ...
                  return (
                    <Link
                      ...
                      style={{
                        ...
                        border: '1.5px solid rgba(0,0,0,0.07)', backgroundColor: '#FFFFFF',
                    ...
                    >
                      <div style={{ position: 'relative', height: '280px', overflow: 'hidden' }}>
                        ...
                        <div style={{ position: 'absolute', bottom: '20px', left: '24px' }}>
                          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '2rem', fontWeight: 700, color: '#FFFFFF', margin: 0, letterSpacing: '-0.01em' }}>
                            {secteur.name}
                          </h2>
                        </div>
                      </div>
      ...
      <style>{`
        .secteur-card:hover { box-shadow: 0 20px 56px rgba(0,0,0,0.12) !important; transform: translateY(-4px); border-color: rgba(212,136,30,0.2) !important; }
