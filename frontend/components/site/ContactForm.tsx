    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: 'radial-gradient(55% 38% at 50% 16%, rgba(212,136,30,0.10) 0%, transparent 70%)',
        }}
      />
        ...
        >
          <div
            ...
            style={{
              ...
              background: 'radial-gradient(50% 60% at 50% 50%, rgba(212,136,30,0.14) 0%, transparent 70%)',
              filter: 'blur(8px)',
            }}
          />
          <div
            style={{
              ...
              border: '1.5px solid rgba(212,136,30,0.22)',
              borderRadius: '18px',
              padding: '22px 28px',
              backdropFilter: 'blur(4px)',
              boxShadow: '0 24px 60px -30px rgba(212,136,30,0.35)',
            }}
          >
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', marginBottom: '32px' }}>
              {c.infos.map((info) => (
                <div key={info.label} style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '14px 16px', borderRadius: '12px', backgroundColor: '#FFFFFF', boxShadow: '0 10px 30px -18px rgba(0,0,0,0.18)', transition: 'transform 0.25s ease' }} className="info-row">
                  <div style={{ width: '38px', height: '38px', borderRadius: '10px', flexShrink: 0, backgroundColor: 'rgba(212,136,30,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ padding: '22px', backgroundColor: '#FFFFFF', borderRadius: '14px', boxShadow: '0 10px 30px -18px rgba(0,0,0,0.18)' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                {sectors.map((s) => (
                  <span key={s.id} style={{ backgroundColor: 'rgba(212,136,30,0.06)', border: '1.5px solid rgba(212,136,30,0.18)', borderRadius: '6px', padding: '5px 14px', fontSize: '11px', fontWeight: 600, color: GOLD, letterSpacing: '0.06em' }}>
                    {s.name}
                  </span>
                ))}
              </div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.1 }}>
            {sent ? (
              <div style={{ borderRadius: '20px', backgroundColor: '#FFFFFF', boxShadow: '0 34px 80px -30px rgba(0,0,0,0.2)', padding: '72px 40px', textAlign: 'center' }}>
                <div style={{ width: '64px', height: '64px', borderRadius: '50%', backgroundColor: 'rgba(212,136,30,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px' }}>
      ...
      <style>{`
        .form-input:focus { border-color: ${GOLD} !important; box-shadow: 0 0 0 3px rgba(212,136,30,0.1) !important; }
        .submit-btn:hover:not(:disabled) { transform: translateY(-1px); box-shadow: 0 22px 48px -16px rgba(212,136,30,0.6) !important; }
